    ...
    <Tabs defaultValue="account" className="flex flex-col items-center w-full">
      ...
      <TabsContent value="imperial">
        <div className="flex gap-4 items-center justify-between">
          <div className="flex flex-col h-32 border border-gray-200 rounded-lg p-4 gap-4 items-center">
      ...
      <div className="flex gap-4 items-center">
          ...
          <div className="flex flex-col border h-32 border-gray-200 rounded-lg p-4 gap-4 items-center">
            <h2 className="font-bold text-xl">Weight</h2>
